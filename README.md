...
2. Lấy mã nguồn:
   > [!IMPORTANT]
   > Hãy mở file [**Code**](file:///c:/Users/Nothing/Desktop/BOTTelegram-QLCT/Code) trong thư mục dự án này, copy toàn bộ nội dung và dán vào cửa sổ biên tập Apps Script (xóa hết code cũ nếu có).
